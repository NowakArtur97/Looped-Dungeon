...
{
    public class RangedCombatEnemyIdleState : EnemyGroundedState
    {
        private int _currentNumberOfIdleCycles;

        public RangedCombatEnemyIdleState(Enemy entity, string animationBoolName) : base(entity, animationBoolName)
        { }
